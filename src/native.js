...
import { GoogleMap, GoogleMapsLatLng, GoogleMapsEvent } from 'ionic-native';
var MapNativeComponent = (function () {
    ...
    MapNativeComponent.prototype.moveMap = function (lat, lng) {
        var ionic = new GoogleMapsLatLng(lat, lng);
        var position = {
            target: ionic,
            zoom: 18,
            tilt: 30
    ...
    MapNativeComponent.prototype.loadMap = function () {
        ...
        var location = new GoogleMapsLatLng(lat, lng);
        var options = {
    ...
    MapNativeComponent.prototype.drawMarker = function (marker) {
        var _this = this;
        var latLng = new GoogleMapsLatLng(marker.latitude, marker.longitude);
        this.map.addMarker({
            position: latLng
